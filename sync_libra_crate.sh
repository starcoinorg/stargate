...
declare -a libra_crates=("types" "common/build_helpers" "common/canonical_serialization" "common/failure_ext" "common/grpc_helpers" "common/grpcio-client" "common/grpcio-extras" "common/logger" "common/proptest_helpers" "common/proto_conv" "crypto/legacy_crypto" "crypto/nextgen_crypto" "storage/accumulator" "storage/sparse_merkle")
